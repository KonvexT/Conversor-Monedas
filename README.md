...
bashgit clone https://github.com/KonvexT/Conversor-Monedas.git
cd Conversor-Monedas

Crea o edita el archivo config.properties en la raíz del proyecto y añade tu API key:

propertiesAPI_KEY=tu_api_key_aqui
...
bashjavac -d out/production/ConversorDeMonedas src/*.java

Ejecuta la aplicación:

bashjava -cp out/production/ConversorDeMonedas Principal

🧩 Descripción de Clases
ClaseDescripciónPrincipalPunto de entrada. Gestiona el menú e interacción con el usuario.ConsultaMonedaSe conecta a la API y obtiene las tasas de cambio actuales.ConversionModelo que representa una conversión (moneda origen, destino, monto).
